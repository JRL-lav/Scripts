...
function DiscordLib:Window(text)
	...
	function ServerHold:Server(text, img)
		...
		ServerWhiteFrame.Transparency = 1
		...
		ServerFrame.Position = UDim2.new(0.01, 0, 1.01262593, 0)
		ServerFrame.Size = UDim2.new(0, 671, 0, 370)
		...
		GlowFrame.Size = UDim2.new(0, 671, 0, 40)
		...
		ChannelTitleFrame.Size = UDim2.new(0, 489, 0, 40)
		...
		ChannelContentFrame.Size = UDim2.new(0, 489, 0, 333)
		...
		function ChannelHold:Channel(text)
			...
			ChannelHolder.Position = UDim2.new(0.065, 0, 0.0241984241, 0)
			...
			function ChannelContent:Toggle(text,default,callback)
				...
				Icon.Position = UDim2.new(0, 7, 0, 8)
			...
			function ChannelContent:Label(text)
				...
				local LableLibrary = {}
				function LableLibrary:SetText(Value)
